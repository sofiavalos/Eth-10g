...
wire [63:0] encoded_tx_data;  // Salida de datos codificados
wire [1:0] encoded_tx_hdr;    // Salida de encabezado codificado
...
// Instancia del módulo XGMII encoder
xgmii_baser_enc_64 xgmii_encoder (
    .clk(rx_clk),
    .rst(rx_rst),
    .xgmii_txd(xgmii_txd),
    .xgmii_txc(xgmii_txc),
...
// Instancia del módulo PHY TX IF
eth_phy_10g_tx_if phy_tx_if (
    .clk(tx_clk),
    .rst(tx_rst),
    .encoded_tx_data(encoded_tx_data),
    .encoded_tx_hdr(encoded_tx_hdr),
    ...
    .cfg_tx_prbs31_enable(1'b0)  // Deshabilita la generación de secuencias PRBS31
);

// Instancia del módulo PHY RX IF
eth_phy_10g_rx #(
    .DATA_WIDTH(64),
    .CTRL_WIDTH(8),
    .HDR_WIDTH(2)
    ...
    .clk(rx_clk),
    .rst(rx_rst),
    .serdes_rx_data(serdes_rx_data),  // Conecta serdes_tx_data a serdes_rx_data 
    .serdes_rx_hdr(serdes_rx_hdr)   // Conecta serdes_tx_hdr a serdes_rx_hdr
);
